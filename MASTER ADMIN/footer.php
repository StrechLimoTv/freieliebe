...
<div class="row-fluid">
				<div class="span12">
					<div class="span2" style="width: 15%;">
						<ul class="unstyled">
							<li><a  href="ts3server://79.133.51.98/?port=9987&nickname=Dashboard Gast">Verbinden mit TS3</a></li>
						</ul>
					</div>
					<div class="span2" style="width: 15%;">
						<ul class="unstyled">
							<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/CSS3_and_HTML5_logos_and_wordmarks.svg/2000px-CSS3_and_HTML5_logos_and_wordmarks.svg.png" height="25" width="45">
						</ul>
					</div>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="span4">
						<p class="muted pull-right">© 2018 Freie Liebe Clan. All rights reserved</p>
					</div>
				</div>
			</div>
  </div>    
